...
function Code(_ref) {
  ...
  var _useContext = React.useContext(RevealContext),
  ...
  return /*#__PURE__*/React__default['default'].createElement("pre", _extends({}, fancyProps, {
    className: className,
...
function Example(_ref) {
  ...
  var show = React.useCallback(function (e, select) {
    e.preventDefault();
    setSelected(select);
  }, [setSelected]);
  ...
  }, "show source")), /*#__PURE__*/React__default['default'].createElement("div", {
    style: {
...
function RevealJS(_ref) {
  ...
  var _useState = React.useState(_objectSpread2(_objectSpread2({}, defaultContextValue), {}, {
  ...
  var revealDeck = React.useRef(null);
  ...
  React.useEffect(function () {
    ...
    if (!revealDeck.current) {
      revealDeck.current = new Reveal__default['default'](revealRef.current, options);
    }
...
window.Prism = Prism__default['default'];
function enablePrismLineNumbers() {
  startup(Prism__default['default']);
}
function addCustomPrismLanguage(languageDef) {
  languageDef(Prism__default['default']);
}
...
var PrismHighlightPlugin = {
  ...
  init: function init(reveal) {
    reveal.on('ready', function () {
      ...
      Prism__default['default'].highlightAllUnder(currentSlide); // scroll to top-most highlighted line
    ...
    reveal.on('slidechanged', function (_ref) {
      ...
      PrismHighlightPlugin.highlightedSlides.set(currentSlide, true);
      Prism__default['default'].highlightAllUnder(currentSlide);
    });
...
var ZoomPlugin = ZoomPlugin__default['default'];
...
exports.Ol = Ol;
exports.P = P;
exports.PrismHighlightPlugin = PrismHighlightPlugin$1;
...
exports.addCustomPrismLanguage = addCustomPrismLanguage;
exports.enablePrismLineNumbers = enablePrismLineNumbers;
