...
declare function Slide({ autoslide, autoAnimate, autoAnimateUnmatched, backgroundColor, backgroundImage, backgroundSize, backgroundPosition, backgroundRepeat, backgroundOpacity, backgroundVideo, backgroundVideoLoop, backgroundVideoMuted, backgroundIframe, backgroundInteractive, children, id, transition, transitionSpeed, visibility, timing, }: SlideProps): JSX.Element;
