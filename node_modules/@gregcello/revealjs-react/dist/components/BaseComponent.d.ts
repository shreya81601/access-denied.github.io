...
export default function BaseComponent<T extends keyof ReactHTML>({ component, autoAnimateId, fragmentIndex, children, ...props }: Props<T>): import("react").DetailedReactHTMLElement<{
    'data-id': string | undefined;
    'data-fragment-index': number | undefined;
    children: import("react").ReactNode;
    fragmentIndex?: number | undefined;
